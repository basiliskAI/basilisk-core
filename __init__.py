...
class SmallTalkSkill(MycroftSkill):
    ...
    def initialize(self):
        ...
        what_does_basil_mean_intent = IntentBuilder("WhatDoesBASILMeanIntent").\
            require("WhatDoesBASILMeanKeyphrase").build()
        self.register_intent(what_does_basil_mean_intent, self.handle_what_does_basil_mean_intent)
    ...
    def handle_what_does_basil_mean_intent(self, message):
        self.speak_dialog("what.does.basil.mean")
